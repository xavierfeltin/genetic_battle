...
export class Missile extends GameObject {
    ...
    constructor(id: number, parent: number, damage: number = Missile.DEFAULT_DAMAGE, range = Missile.DEFAULT_LIFE) {
        super(id);
...
export class FactoryMissile {
    ...
    public create(id: number, parent: number, range: number): Missile {
